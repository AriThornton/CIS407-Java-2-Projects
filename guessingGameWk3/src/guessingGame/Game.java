...
public class Game {
	...
	public void displayGuessAgainMessage() {
		int guessDiffNew = this.guessNumber - this.number;
		int guessDiffOld = this.previousGuess - this.number;
		
		int guessDiffAbs = Math.abs(guessDiffOld) - Math.abs(guessDiffNew);
