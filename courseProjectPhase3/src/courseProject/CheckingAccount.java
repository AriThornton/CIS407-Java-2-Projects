...
public class CheckingAccount extends Account implements AccountInterface {
	...
	public void checkOverdraft() {
		if (this.balance < 0) {
			...
			System.out.println("Checking account has been overdrawn! An overdraft fee has been applied.");
		}
	}
	@Override
	...
	@Override
	public void performTransaction(TRANSACTION_TYPE type, double amnt) {
